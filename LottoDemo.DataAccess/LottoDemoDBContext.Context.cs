...
namespace LottoDemo.DataAccess
{
    ...
    public partial class LotteryDemoDBEntities : DbContext
    {
        ...
        public virtual DbSet<GameWinningsTier> GameWinningsTiers { get; set; }
        public virtual DbSet<DrawStatistic> DrawStatistics { get; set; }
        public virtual DbSet<WinningTicket> WinningTickets { get; set; }
